...
- [1. 📝 概述](#1--概述)
- [2. 🤔 “canvas” 是什么？](#2--canvas-是什么)
- [3. 🤔 “canvas” 都有哪些特点？](#3--canvas-都有哪些特点)
- [4. 🤔 “canvas” 都有哪些应用场景？](#4--canvas-都有哪些应用场景)
- [5. 🆚 前端的两大绘图技术：svg 和 canvas 之间的区别都有哪些？](#5--前端的两大绘图技术svg-和-canvas-之间的区别都有哪些)
- [6. 🆚 区分 Image 和 Graphic](#6--区分-image-和-graphic)
- [7. 💻 demos.1 - canvas 的基本使用](#7--demos1---canvas-的基本使用)
...
## 5. 🆚 前端的两大绘图技术：svg 和 canvas 之间的区别都有哪些？
